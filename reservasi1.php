...
<tr>
    ...
    <td> <a href="hapus-reservasi.php?id=<?php echo $tampil['id_pemesan'];?>">haposs</a>
    <a href="edit-reservasi.php?id=<?php echo $tampil['id_pemesan'];?>">edid</a></td>
</tr>
...
?>
    ...
    <a href="input-reservasi.php">tambah data baru</a>
    </html>